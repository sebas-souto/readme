...
EL SCANF SOLO FUNCIONA CUANDO SE ESPERA UN TIPO DE CARACTER DE UN LONGITUD DETERMINADA POR EJEMPLO SI SABES QUE 
VA METER POR TECLADO UN NUMERO DEL 1 A 1000 Y NUNCA UNA LETRA, PERO Y SI METES 100e455a*/
#include <stdio.h>
void emitir_voto();
